...
const REQUIRED_COLUMNS: Record<string, readonly string[]> = {
  ...
  achievement: ['article_id', 'title', 'grade', 'points', 'description', 'status'],
  house: ['article_id', 'title', 'house_id', 'city', 'rent', 'size', 'beds', 'status'],
  imbuement: ['article_id', 'title', 'tier', 'category', 'type', 'effect', 'slots', 'status'],
  charm: ['article_id', 'title', 'type', 'effect', 'cost_level_1', 'status'],
  mount: ['article_id', 'title', 'speed', 'taming_method', 'price', 'status'],
  outfit: ['article_id', 'title', 'outfit_type', 'full_price', 'status'],
  book: ['article_id', 'title', 'book_type', 'author', 'text', 'status'],
  world: ['article_id', 'title', 'location', 'pvp_type', 'battleye', 'battleye_type'],
  game_update: ['article_id', 'title', 'release_date', 'type_primary', 'summary'],
  // Child tables the detail sections read.
  creature_ability: ['creature_id', 'name', 'effect', 'element'],
  creature_max_damage: ['creature_id', 'physical', 'fire', 'total'],
  creature_sound: ['creature_id', 'content'],
  item_key: ['item_id', 'title', 'number', 'material', 'location'],
  item_sound: ['item_id', 'content'],
  item_store_offer: ['item_id', 'price', 'amount', 'currency'],
  item_proficiency_perk: ['item_id', 'proficiency_level', 'effect'],
  npc_job: ['npc_id', 'name'],
  npc_race: ['npc_id', 'name'],
  npc_destination: ['npc_id', 'name', 'price'],
